...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($run) > 0) {
        ...
        echo "<script>window.open('staff_attendance.php', '_self')</script>";
                ...
                <div class="col-md-6">
                    ...
                    <form role="form" action="login.php" method="post" class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            Enter email:
                            <input class="form-control" name="email" placeholder="JBN mail" type="email" required />
                        </div>
                        <div class="form-group">
                            Password:
                            <input class="form-control" name="password" placeholder="Enter passsword" type="password" required />
                        </div>
                        <div class="form-group">
